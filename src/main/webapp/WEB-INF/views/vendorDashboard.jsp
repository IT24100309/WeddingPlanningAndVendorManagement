    ...
    <div class="content-wrapper">
        <div class="container py-4">
                ...
                <div class="card-body">
                    <form method="get" action="vendorDashboard" class="row g-3 align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            <a href="sortVendorsByPrice" class="btn btn-outline-info">Sort by Price</a>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="mt-4">
                ...
                <a href="bookingForm" class="btn btn-info me-2">
                    Make a Booking
                </a>
                <a href="sortVendorsByPrice" class="btn btn-outline-info">
                    View Vendors Sorted by Price
                </a>
            </div>
        </div>
    </div>
