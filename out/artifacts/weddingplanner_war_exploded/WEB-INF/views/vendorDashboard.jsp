    ...
    <div class="content-wrapper">
        <div class="container py-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1>Vendors</h1>
                <a href="addVendor" class="btn btn-success">
                    ...
                    <c:choose>
                        <c:when test="${empty vendors}">
                            <div class="text-center py-5">
                                ...
                                <h3 class="text-muted">No vendors found</h3>
                                <p class="text-muted mb-4">
                                    <c:choose>
                                        <c:when test="${not empty param.searchType}">
                                            No vendors found matching "${param.searchType}"
                                        </c:when>
                                        <c:otherwise>
                                ...
                                <a href="addVendor" class="btn btn-primary">
                                    <i class="bi bi-plus-circle"></i> Add New Vendor
                                </a>
                            </div>
                        </c:when>
